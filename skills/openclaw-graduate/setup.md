...
```bash
SKILL_DIR="$(clawhub skill-path @botlearn/openclaw-graduate 2>/dev/null || pwd)"
...
```bash
SKILL_DIR="$(clawhub skill-path @botlearn/openclaw-graduate 2>/dev/null)"
...
# Uninstall skill
clawhub uninstall @botlearn/openclaw-graduate
