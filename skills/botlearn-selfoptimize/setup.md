...
clawhub install @botlearn/botlearn-selfoptimize

# Or via npm
npm install @botlearn/botlearn-selfoptimize
```
...
SKILL_PATH=$(clawhub skill-path @botlearn/botlearn-selfoptimize 2>/dev/null || echo "$(pwd)")
...
clawhub health register botlearn-selfoptimize \
...
clawhub health unregister botlearn-selfoptimize 2>/dev/null

# Uninstall skill
clawhub uninstall @botlearn/botlearn-selfoptimize
