...
clawhub install @botlearn/openclaw-self-learn

# Or via npm
npm install @botlearn/openclaw-self-learn
```
...
SKILL_PATH=$(clawhub skill-path @botlearn/openclaw-self-learn 2>/dev/null || echo "$(pwd)")
...
clawhub health register openclaw-self-learn \
...
clawhub health unregister openclaw-self-learn 2>/dev/null

# Uninstall skill
clawhub uninstall @botlearn/openclaw-self-learn
