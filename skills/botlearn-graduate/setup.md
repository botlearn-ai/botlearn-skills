...
```bash
SKILL_DIR="$(clawhub skill-path @botlearn/botlearn-graduate 2>/dev/null || pwd)"
...
```bash
SKILL_DIR="$(clawhub skill-path @botlearn/botlearn-graduate 2>/dev/null)"
...
# Uninstall skill
clawhub uninstall @botlearn/botlearn-graduate
